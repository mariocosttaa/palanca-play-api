...
test('business user can create multiple bookings when sending non-contiguous slots', function () {
    // Setup
    ...
    $bookings = Booking::where('user_id', $client->id)->orderBy('start_time')->get();
