...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'availabilities.*.day_of_week_recurring' => 'dia da semana',
        'availabilities.*.specific_date' => 'data específica',
        'availabilities.*.start_time' => 'hora de início',
        'availabilities.*.end_time' => 'hora de término',
        'availabilities.*.is_available' => 'disponibilidade',
    ],
];
