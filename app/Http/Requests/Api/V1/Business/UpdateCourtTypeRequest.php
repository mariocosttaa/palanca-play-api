 ...
 */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'interval_time_minutes' => 'required|integer|min:5|max:120|multiple_of:5',
            'buffer_time_minutes' => 'required|integer|min:0|max:120|multiple_of:5',
    ...
    public function messages(): array
    {
        return [
            ...
            'interval_time_minutes.multiple_of' => 'O intervalo de tempo deve ser múltiplo de 5',
            ...
            'buffer_time_minutes.multiple_of' => 'O buffer de tempo deve ser múltiplo de 5',
