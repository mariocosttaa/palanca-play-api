...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="title">Booking Updated</div>
            ...
            <div class="text" style="margin-top: 32px;">
                Please verify the new details of your booking above.
            </div>
        </div>

        <div class="footer">
            <p>You're receiving this email because a booking was updated on PalancaPlay.</p>
